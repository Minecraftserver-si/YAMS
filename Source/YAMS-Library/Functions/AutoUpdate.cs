...
namespace YAMS
{
    public static class AutoUpdate
    {
        ...
        public static Dictionary<string, string> dicAddOnURLS = new Dictionary<string, string>
        {
            ...
            { "overviewer-x86", "https://github.com/downloads/overviewer/Minecraft-Overviewer/overviewer-xxx-win32.zip" },
            { "overviewer-x64", "https://github.com/downloads/overviewer/Minecraft-Overviewer/overviewer-xxx-win64.zip" },
        ...
        //Default versions
        private static string strOverviewerVer = "0.4.4";
